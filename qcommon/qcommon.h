...
// Generated by the CMake build. The .vcxproj build does not produce it, hence the guard.
#if defined(__has_include)
#	if __has_include("kpd_version.h")
#		include "kpd_version.h"
#	endif
#endif
#ifndef KPD_GIT_REV
#define KPD_GIT_REV "unknown"
#endif

// This is a fork: the i386 aggregate-return convention and a good deal else differ from upstream
// kpded 2.2, so the build has to say so rather than claim to be it.
#define KPD_FORK_STRING VERSION "-molycode " KPD_GIT_REV

#if KINGPIN
#define R1Q2_VERSION_STRING "kpded " KPD_FORK_STRING " " CPUSTRING " " __DATE__ " " BUILDSTRING
#else
#define R1Q2_VERSION_STRING "R1Q2/kpded " KPD_FORK_STRING " " CPUSTRING " " __DATE__ " " BUILDSTRING
#endif
